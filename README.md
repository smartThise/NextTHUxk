...
- **Liquid Glass 折射**：内置 SVG `feDisplacementMap` 位移滤镜（径向位移图：中心不位移、边缘强弯折 = 透镜效应），通过 `backdrop-filter: url(#lg-refract)` 应用到顶栏/课程卡/弹窗/启动胶囊——玻璃边缘真正"折射扭曲"背后内容，而非单纯磨砂（Chrome 138+；旧浏览器自动降级磨砂）
...
<p align="center">
  <img src="qrcode_group.jpg" alt="NextTHUxk 用户 QQ 群" width="240"/>
</p>
